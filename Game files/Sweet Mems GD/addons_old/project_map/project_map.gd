...
func _enter_tree():
	...
	connect("_begin_node_move",Callable(self,"_on_begin_node_move"))
	connect("_end_node_move",Callable(self,"_on_end_node_move"))
...
func create_file_nodes(file_paths:Array, pos):
	...
	for file_path in file_paths:
		...
		#this sets the script variable for saving, do not remove_at
